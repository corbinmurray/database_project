...
test = Database("/Users/corbinmurray/Projects/database_env/database_project/data/weather.db")

city_list = ["Wichita", "Chicago", "Denver", "Austin", "Sacramento", "Kalispell", "Billings", "Houston", "Seattle", "Nashville", "Milwaukee", "Atlanta", "Lincoln", "Reno","Wells"]

country = "United States"

for city in city_list:
    data = Data(city_name=city, city_country=country)
